...
const permissionMessage = new ContainerBuilder({
    ...
    components: [
        ...
        new TextDisplayBuilder({content: `### *To solve this you can take either..* \ \n\n**Manually Fix Permissions:** \nYou can manually re-assign Sessions Bot its required permissions by accessing: \n**\`Server Settings > Roles > Sessions > Edit > Permissions\`** \nSee documentation for ***each required permission*** and confirm it's enabled.\ \n-# Feeling lazy? You can grant **all permissions** to Sessions Bot with the 'Administrator' permission. \ \n\n**Re-Invite the Bot:** \nYou can fully remove and re-add Sessions Bot to your server. \n-# **NOTE: This will RESET your bot configuration** and break any existing sessions/schedules!`}),
        new SeparatorBuilder(),
